...
from typing import Any, List, TYPE_CHECKING, Callable, Optional
...
@register_optimizer("dadapt-adam")
class FairseqAdam(FairseqOptimizer):
    ...
    def __init__(self, cfg: FairseqAdamConfig, params):
        super().__init__(cfg)
        self._optimizer = DAdaptAdam(params, **self.optimizer_config)
...
class DAdaptAdam(torch.optim.Optimizer):
    ...
    def __init__(self, params, lr=0.01,
                 ...
                 weight_decay=0.05, log_every=0,
                 decouple=True,
                 use_bias_correction=False,
                 d0=1, growth_rate=float('inf'),
                 fsdp_in_use=False):
        if not 0.0 < d0:
